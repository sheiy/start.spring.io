...
public class Beans {
	...
	public Beans(MustacheTemplateRenderer templateRenderer, ProjectDescription projectDescription) {
		String packageName = projectDescription.getPackageName();
		Map<String, Object> model = new HashMap<>(1, 1);
		model.put("package", packageName);
		this.section = new MustacheSection(templateRenderer, "beans", model);
	}
