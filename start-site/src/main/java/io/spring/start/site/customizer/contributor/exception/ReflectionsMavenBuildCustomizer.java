...
public class ReflectionsMavenBuildCustomizer implements BuildCustomizer<MavenBuild> {

	@Override
	public void customize(MavenBuild build) {
		MavenDependency reflections = MavenDependency.withCoordinates("org.reflections", "reflections")
