...
public class AuthenticationFilter {
	...
	public AuthenticationFilter(MustacheTemplateRenderer templateRenderer, ProjectDescription projectDescription) {
		String packageName = projectDescription.getPackageName();
		Map<String, Object> model = new HashMap<>(1, 1);
		model.put("package", packageName);
		this.section = new MustacheSection(templateRenderer, "security/authentication-filter", model);
	}
