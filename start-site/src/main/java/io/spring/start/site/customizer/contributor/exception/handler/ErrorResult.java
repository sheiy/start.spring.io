...
public class ErrorResult {
	...
	public ErrorResult(MustacheTemplateRenderer templateRenderer, ProjectDescription projectDescription) {
		String packageName = projectDescription.getPackageName();
		Map<String, Object> model = new HashMap<>(1, 1);
		model.put("package", packageName);
		this.section = new MustacheSection(templateRenderer, "exception/handler/error-result", model);
	}
